...
def one_img_process(therma_img_path,therma_rgb_path,visible_img_path,out_img,kwargs):
    ...
    thermal_visible_c = ThermalVisble(thermal_tiff_path=therma_img_path,
                                      ...
                                      scale = {'thermal_upsample':kwargs['thermal_upsample'],
                                               'visible_upsample':kwargs['visible_upsample']},
                                      crop_size=kwargs['crop_size'],
                                      attention_flag=True)
    save_dict={ 'visible_rgb':'png',
                'thermal_rgb':'png',
               }
...
if __name__=='__main__':
    ...
    thermal_path = 'E:/work/hongquan_image/20220630/zj/DJI_20220624110934_0028_T.tif'
    thermal_rgb_path = 'E:/work/hongquan_image/20220630/zj/DJI_20220624110934_0028_T.JPG'
    visible_path = 'E:/work/hongquan_image/20220630/zj/DJI_20220624110934_0028_Z.JPG'
    output_path = 'E:/work/hongquan_image/20220630/result'
